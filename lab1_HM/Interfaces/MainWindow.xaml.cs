...
namespace Interfaces
{
    ...
    public partial class MainWindow : RibbonWindow
    {
        ...
        public string[] AllColors
        {
            get
            {
                return new string[] { "Black" ,"Red", "Green", "Blue", "Brown", "Cyan", "DarkBlue", "DarkOrange", "Ivory" };
            }
        }
        ...
        private void Color_SelectionChange(object sender, SelectionChangedEventArgs e)
        {
            SolidColorBrush BrushItem = (SolidColorBrush)new BrushConverter().ConvertFromString(e.AddedItems[0].ToString());
            try
            {
                ApplyPropertyValueToSelectedText(TextElement.ForegroundProperty, BrushItem);
            }
            catch (Exception) { }
        }
